...
CATALOGUE_MATERIAUX: dict[str, dict] = {
    ...
    "Bouleau": creer_materiau(
        nom="Bouleau",
        categorie="bois",
        couleur_rgb=[0.92, 0.87, 0.76],
        texture_diffuse=_chemin_texture("bouleau_diffuse.jpg"),
        texture_bump=_chemin_texture("bouleau_bump.jpg"),
        rugosite=0.42,
        specular=0.3,
    ),
    "Wenge": creer_materiau(
        nom="Wenge",
        categorie="bois",
        couleur_rgb=[0.25, 0.18, 0.12],
        texture_diffuse=_chemin_texture("wenge_diffuse.jpg"),
        texture_bump=_chemin_texture("wenge_bump.jpg"),
        rugosite=0.40,
        specular=0.35,
    ),
